...
#####--------change directory-----------####
############################################
os.chdir(r'K:\New folder\New_05222021\Marcellus\Final_plot\set1-2') #main folder #K:\New folder\New_05222021\Marcellus\Final_plot\set1 #C:\My_works\Mancos&Marcellus\Marcellus\Train
folder_with_image = ''
df = pd.DataFrame()
...
# plt.title('ee')
# plt.show()
path = r'K:\New folder\New_05222021\Marcellus\Final_plot\set1-2'
os.chdir(r'K:\New folder\New_05222021\Marcellus\Final_plot\set1-2') #main folder #C:\My_works\Mancos&Marcellus\Marcellus\Train
